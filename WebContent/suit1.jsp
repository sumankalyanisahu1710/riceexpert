...
<tr><td><h3>PRICE per ACRE/DECIMILE(KG ):</h3></td>
<td><input type="text" id="Text1" name="larea" value="14"  pattern="[0-9]"></td></tr>

<tr><td><h3>Rice per acre/decimile(Kg):</h3></td>
<td><input type="text" id="Text2" name="larea1"  pattern="[0-9]"></td></tr>
...
<input type=submit  name="but2" value="Next" ID="Button2" onclick="location='Feedback.jsp'" />
