...
<div class="entry" align="center">
   ...
   <table ID="Table3">
        ...
        <tr ><td   align=center>
	<center><b><FONT Size=4 face=verdana color="#006600">Insect Management</ center>
	<br><br></td ></tr >  <tr>
...
<td>
<a href="insect6.jsp"><img name=plant01 src="E:\RICE EXPERT\WebContent\images\rice leaf.jpg" height="100" width="80" ></a>
<br>

<input type="radio"  name="test" value="plant01" id="Radio1" onclick="location='insect6.jsp'"/><font color="#000066" size=2><b> Leaf</b></font>


</td>
 
<td>
<a href="javascript:popUp('../exowhem_picture/pic_plant_part/stem.jpg')"><img name=plant03 src="E:\RICE EXPERT\WebContent\images\stem.jpg" height="100" width="80" ></a>
<br>

<input type="radio"  name="test" value="plant03" id="Radio1" onclick="location='insect7.jsp'"/><font color="#000066" size=2><b> Panicle</b></font>


</td>
 
<td>
<a href="javascript:popUp('../exowhem_picture/pic_plant_part/earhead.jpg')"><img name=plant06 src="E:\RICE EXPERT\WebContent\images\grain.jpg" height="100" width="80" ></a>
<br>

<input type="radio"  name="test" value="plant06" id="Radio1" onclick="location='insect8.jsp'" /><font color="#000066" size=2><b> Grain</b></font>
