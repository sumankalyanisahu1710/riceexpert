...
<div class="box" id="box3">
                        	<h2 class="title1" align="center"><font color="black">Insect Identified is</font></h2>
       ...
       // String s1=(String)session.getAttribute("tt");
        ...
        <TABLE BORDER="1">
          ...
          <%   String gh=rs.getString(3);
               session.setAttribute("sdesc",gh);%>
           </TR>
       </TABLE>
       <BR>
       <input type="button" value="Disease Details" onclick="location.href='insect9.jsp';" />
       <% 
