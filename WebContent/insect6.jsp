...
<script language="javascript">
    function f_back() {
		...
		<script language="javascript">
		    function home_back() {
		        document.location.href = "/wheat/default.asp";
		    }
</script>
<style>
...
<center><b><FONT Size=4 face=verdana color="#006600">Insect Management</FONT></b></center><br />
<table width=70% align=center>
<tr>
<td align=center>
<font color="#003366" size=2><b>Please Answer The Question To Identify The Insect</b></font>
</td></tr>
</table>  
<br />
...
<form method=post name="frm2" action="NEWproInsect.jsp" ID="Form2">
<center>
...
<input type=radio name="symptoms" value="<%=rs.getString(2) %>"  checked ID="Radio1"><font face="arial" color="#000066" size=2>&nbsp;<b><%=rs.getString(2) %></b></font>
</td>
...
<table ID="Table3" width=100%>
	...
	<br>
		<center>
		<input type="button" name=but4 value="back" ID="Button6" onclick="f_back()" />
		<input type="submit" name=but2 value="next" ID="Button7" />
		</center>
