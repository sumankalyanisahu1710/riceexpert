...
<form action="Districtpro.jsp" method="post">
<table>
   <tr>
 <td><p style="font-size:18px;">SlNo :</td>
  <td><input type="text" name="slno" required></td>
  </tr><br> </p>
  
   <td><p style="font-size:18px;">Labname:</td>
  <td><input type="text" name="lname" required></td>
  </tr></p>
  
    <td><p style="font-size:18px;">State :</td>
  <td><input type="text" name="state" required></td>
  </tr></p>
   <td><p style="font-size:18px;">Dist :</td>
  <td><input type="text" name="dist" required></td>
  </tr></p>
   <td><p style="font-size:18px;">Block :</td>
  <td><input type="text" name="block" required></td>
  </tr></p>
   <td><p style="font-size:18px;">Village :</td>
  <td><input type="text" name="village" required></td>
  </tr></p>
  <td><p style="font-size:18px;">Mobile :</td>
  <td><input type="text" name="mobile" pattern="[0-9]"></td>
  </tr></p>
  <td><p style="font-size:18px;">Microtf :</td>
  <td><input type="text" name="microtf" required></td>
  </tr></p>
  <td><p style="font-size:18px;">Borontf :</td>
  <td><input type="text" name="borontf" required></td>
  </tr></p>
  <td><p style="font-size:18px;">Sulphurtf :</td>
  <td><input type="text" name="sulp required"></td>
  </tr></p>
  <td><p style="font-size:18px;">Status :</td>
