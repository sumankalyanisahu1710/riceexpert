...
<a href="blast_sym3 LEAF.png"><img name=plant01 src="E:\RICE EXPERT\WebContent\images\blast leaf.jpg" height="100" width="80" ></a>
<br>

<input type="radio"  name="parts"  value="leaf" id="Radio1" onclick="location='dies6.jsp'"/><font color="#000066" size=2><b> Leaf</b></font>
<br>
<b>
...
<a href="node.jsp"><img name=plant02 src="E:\rice cultivation\WebContent\images\rice node.jpg" height="100" width="80" ></a>
<br>

<input type="radio"  name="test" value="plant01" id="Radio" onclick="location='node.jsp'" /><font color="#000066" size=2><b> Node</b></font>
<br>
<b>
...
<td>
<a href="javascript:popUp('../exowhem_picture/pic_plant_part/grain.jpg')"><img name=plant07 src="E:\RICE EXPERT\WebContent\images\neck blast.jpg" height="100" width="80" ></a>
<br>

<input type="radio"  name="test" value="plant07" id="Radio1" onclick="location='neck.jsp'"  /><font color="#000066" size=2><b> Neck</b></font>
<br>
...
<td>
<a href="javascript:popUp('../exowhem_picture/pic_plant_part/root.jpg')"><img name=plant08 src="E:\rice cultivation\WebContent\images\collar.jpg" height="100" width="80" ></a>
<br>

<input type="radio"  name="test" value="plant08" id="Radio1" onclick="location='root.jsp'" /><font color="#000066" size=2><b> Root</b></font>
<br>

</td>

<td>
<a href="javascript:popUp('../exowhem_picture/pic_plant_part/root.jpg')"><img name=plant08 src="E:\RICE EXPERT\WebContent\images\panicle blast.jpg" height="100" width="80" ></a>
<br>

<input type="radio"  name="test" value="plant08" id="Radio1"  onclick="location='panicle.jsp'"/><font color="#000066" size=2><b> Panicle</b></font>
<br>
</td>
...
<input type="radio"  name="test" value="plant08" id="Radio1"  onclick="location='grain.jsp'"/><font color="#000066" size=2><b> Grain</b></font>
<br>
</td>
</tr>
</center>
