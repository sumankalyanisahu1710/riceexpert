...
<a href="Login.jsp" class="dropbtn"><b>Admin</b></a></li>
	             ...
	             <li><a href="vedio.jsp"><b>Videos</b></a>
                    ...
                    <li><a href="vedio.jsp"><b>Case Studies</b></a>
...
<div class="box" id="box3">
                        	<h2 class="title1" align="center"><font color="black">Case Study</font></h2>
...
<table width="100%">
<tr><td>
<img height="205" src="E:\RICE EXPERT\WebContent\images\mr sahu.jpg"  style="margin-right:20px; width:250px; float:left; border:thick #003300 solid;" />
<p align="justify">My name is Manoranjan Sahu & i am from bhadrak.I am a retired bank manager.After retirement i thought of taking care of my land myself but i didn't have adequate knowledge about farming methods,rice varieties,soil types,diseases,etc..But this site helped me a lot to improve my knowledge on farming process.I decided to cultivate "SWARNA","HAJAR 9" rice variety in 5 acres & 2 acres.At nursery stage big irregular patches appeared on leaves & as i am new grower so i got tensed about the disorder.But after following this website i succesfully diagnosised this disease type & also gained knowledge how to manage this disease.I Apply N in three split doses (50% basal, 25% in tillering phase and 25% N in panicle initiation stage).The disease name is BLAST.Also watched the videos of whole rice cultivation process & was very much pleased to know about all the advanced machines.Really it will make work of a farmer easier.U should keep the work going on & provide new new information & technology.  </p>
<br>
</td></tr>      
